...
//	var OK bool
//	dal.DB.Select("status").Where("user_id=? AND folow_id=?", userid, followid).Find(&OK)
//	return OK
//}
//
//// QueryFans 查询粉丝
...
//	var users []*USer
//	dal.DB.Where("follow_id=?", followid).Find(&users)
...
//	var users []*USer
//	dal.DB.Where("user_id=?", userid).Find(&users)
//	return &UserList{Users: users}
//}
